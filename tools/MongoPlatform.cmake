...
set_property(TARGET _amongoc-platform PROPERTY EXPORT_NAME detail::c_platform)
install(TARGETS _amongoc-platform EXPORT amongoc-targets)
...
function (mongo_platform_compile_options)
    ...
    target_compile_options(_amongoc-platform INTERFACE ${ARGN})
endfunction ()
...
function(mongo_platform_link_options)
    ...
    target_link_options(_amongoc-platform INTERFACE ${ARGN})
endfunction()
...
function(mongo_platform_use_target)
    ...
    foreach(item IN LISTS ARGN)
        if(item MATCHES "::")
            ...
            target_link_libraries(_amongoc-platform INTERFACE "${item}")
        else()
            # Generate a configure-time-error if the named item is not the name of a target
            target_link_libraries(_amongoc-platform INTERFACE
