...
extern mlib_constexpr bool _bson_key_eq(const bson_iterator, mlib_str_view) mlib_noexcept;
...
extern inline mlib_str_view          bson_iterator_utf8(bson_iterator it) mlib_noexcept;
