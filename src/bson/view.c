...
extern mlib_constexpr bool bson_done(bson_iterator it) mlib_noexcept;
...
extern mlib_constexpr struct bson_decimal128 bson_iterator_decimal128(bson_iterator) mlib_noexcept;
